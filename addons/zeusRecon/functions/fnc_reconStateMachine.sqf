...
case (0): { // Start: Gather friendly units
...
case (1): { // Search for targets on each friendly unit
...
case (2): { // Filter deleated and process target list
...
case (4): { // Send add/remove zeus units info to server
...
case (5): { // Check medical status of friendly groups
...
case (6): { // Filter reports if group is null or time out
