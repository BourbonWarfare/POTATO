...
class RscDisplayMain: RscStandardDisplay {
    class controls {
        class GVAR(quickConnectToServer_main): RscButton { // port 2303
            ...
            onLoad = "call compileScript ['z\potato\addons\tempServerMoveStuff\tempUpgradeServerPW.sqf']; params ['_ctrl'];  private _passwordCache = profileNamespace getVariable ['cba_ui_ServerPasswords', [[], []]];  private _index = (_passwordCache select 0) find '104.128.50.152:2303';  if (_index isEqualTo -1) then { _ctrl ctrlShow false; };";
