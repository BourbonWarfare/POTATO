...
[_player, "forceWalk", "ACE_csw", false] call ACEFUNC(common,statusEffect_set);
...
[_player, "DefaultAction", _player getVariable [QGVAR(MoveTripod), -1]] call ACEFUNC(common,removeActionEventHandler);
