...
y = 2048 - 204.8 - 1638.4 * 0.9747547978
pdb.gimp_pencil(draw, 4, [1024, y, -163+1024, y])
y = 2048 - 204.8 - 1638.4 * 0.8974736676
pdb.gimp_pencil(draw, 4, [-41+1024, y, -122+1024, y])
y = 2048 - 204.8 - 1638.4 * 0.8173327362
pdb.gimp_pencil(draw, 4, [1024, y, -163+1024, y])
y = 2048 - 204.8 - 1638.4 * 0.7328298983
pdb.gimp_pencil(draw, 4, [-41+1024, y, -122+1024, y])
y = 2048 - 204.8 - 1638.4 * 0.6417114491
pdb.gimp_pencil(draw, 4, [1024, y, -163+1024, y])
y = 2048 - 204.8 - 1638.4 * 0.5401105295
pdb.gimp_pencil(draw, 4, [-41+1024, y, -122+1024, y])
y = 2048 - 204.8 - 1638.4 * 0.4199158504
pdb.gimp_pencil(draw, 4, [1024, y, -163+1024, y])
y = 2048 - 204.8 - 1638.4 * 0.3467822992
pdb.gimp_pencil(draw, 4, [-41+1024, y, -122+1024, y])
y = 2048 - 204.8 - 1638.4 * 0.2553540946
pdb.gimp_pencil(draw, 4, [1024, y, -163+1024, y])
y = 2048 - 204.8 - 1638.4 * 0.1806802336
pdb.gimp_pencil(draw, 4, [-41+1024, y, -122+1024, y])
y = 2048 - 204.8 - 1638.4 * 0
pdb.gimp_pencil(draw, 4, [1024, y, -163+1024, y])

y = 2048 - 204.8 - 60 - 1638.4 * 0.9747547978
pdb.gimp_text (img, draw, 1024-136+30, y, "100", 0, TRUE, 50, 0, "*", "*", "*", "*", "*", "*", "*", "*" )
y = 2048 - 204.8 - 60 - 1638.4 * 0.8173327362
pdb.gimp_text (img, draw, 1024-136+30, y, "200", 0, TRUE, 50, 0, "*", "*", "*", "*", "*", "*", "*", "*" )
y = 2048 - 204.8 - 60 - 1638.4 * 0.6417114491
pdb.gimp_text (img, draw, 1024-136+30, y, "300", 0, TRUE, 50, 0, "*", "*", "*", "*", "*", "*", "*", "*" )
y = 2048 - 204.8 - 60 - 1638.4 * 0.4199158504
pdb.gimp_text (img, draw, 1024-136+30, y, "400", 0, TRUE, 50, 0, "*", "*", "*", "*", "*", "*", "*", "*" )
y = 2048 - 204.8 - 60 - 1638.4 * 0.2553540946
pdb.gimp_text (img, draw, 1024-136+30, y, "450", 0, TRUE, 50, 0, "*", "*", "*", "*", "*", "*", "*", "*" )
y = 2048 - 204.8 - 60 - 1638.4 * 0
pdb.gimp_text (img, draw, 1024-136+30, y, "480", 0, TRUE, 50, 0, "*", "*", "*", "*", "*", "*", "*", "*" )
