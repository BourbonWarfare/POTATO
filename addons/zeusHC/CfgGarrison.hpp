class CfgGarrison {
    ...
    class rhs_faction_msv {
        units[] = {"rhs_msv_junior_sergeant","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_machinegunner","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_machinegunner","rhs_msv_at"};
    };
    class opf_f {
