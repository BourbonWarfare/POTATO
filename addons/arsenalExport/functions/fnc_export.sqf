...
_lines pushBack format ['#define CAMO_UNIFORM "%1"', [GVAR(loadout_uniform)] call _fnc_default];
_lines pushBack format ['#define CAMO_VEST "%1"', [GVAR(loadout_vest)] call _fnc_default];
_lines pushBack format ['#define CAMO_BACKPACK "%1"', [GVAR(loadout_backpack)] call _fnc_default];
_lines pushBack format ['#define CARRYALL "%1"', [GVAR(loadout_carryall),GVAR(loadout_backpack)] call _fnc_default];
_lines pushBack format ['#define CAMO_HEADGEAR "%1"', [GVAR(loadout_headgear)] call _fnc_default];
...
_lines pushBack format ['#define CAMO_UNIFORM_PILOT "%1"', [GVAR(loadout_pilot_uniform)] call _fnc_default];
_lines pushBack format ['#define CAMO_VEST_PILOT "%1"', [GVAR(loadout_pilot_vest)] call _fnc_default];
_lines pushBack format ['#define CAMO_BACKPACK_PILOT "%1"', [GVAR(loadout_pilot_backpack)] call _fnc_default];
_lines pushBack format ['#define CAMO_HEADGEAR_PILOT "%1"', [GVAR(loadout_pilot_headgear)] call _fnc_default];

_lines pushBack format ["// Vic Crew Camo set"];
_lines pushBack format ['#define CAMO_UNIFORM_VICC "%1"', [GVAR(loadout_vicc_uniform)] call _fnc_default];
_lines pushBack format ['#define CAMO_VEST_VICC "%1"', [GVAR(loadout_vicc_vest)] call _fnc_default];
_lines pushBack format ['#define CAMO_BACKPACK_VICC "%1"', [GVAR(loadout_vicc_backpack)] call _fnc_default];
_lines pushBack format ['#define CAMO_HEADGEAR_VICC "%1"', [GVAR(loadout_vicc_headgear)] call _fnc_default];

_lines pushBack format ["// Rifle"];
_lines pushBack format ['#define RIFLE "%1"', [GVAR(loadout_rifle)] call _fnc_default];
...
_lines pushBack format ['#define GLRIFLE "%1"', [GVAR(loadout_glrifle)] call _fnc_default];
...
_lines pushBack format ['#define CARBINE "%1"', [GVAR(loadout_carbine)] call _fnc_default];
...
_lines pushBack format ['#define AR "%1"', [GVAR(loadout_ar)] call _fnc_default];
...
_lines pushBack format ['#define AT "%1"', [GVAR(loadout_at)] call _fnc_default];
...
_lines pushBack format ['#define MMG "%1"', [GVAR(loadout_mmg)] call _fnc_default];
...
_lines pushBack format ['#define MAT "%1"', [GVAR(loadout_mat)] call _fnc_default];
...
_lines pushBack format ['#define HMG "%1"', [GVAR(loadout_hmg)] call _fnc_default];
_lines pushBack format ['#define HMG_TRI_HI "%1"', [GVAR(loadout_hmg_tri_1)] call _fnc_default];
_lines pushBack format ['#define HMG_TRI_LO "%1"', [GVAR(loadout_hmg_tri_2)] call _fnc_default];
...
_lines pushBack format ['#define HAT "%1"', [GVAR(loadout_hat)] call _fnc_default];
_lines pushBack format ['#define HAT_TRI_HI "%1"', [GVAR(loadout_hat_tri_1)] call _fnc_default];
...
_lines pushBack format ['#define SAM "%1"', [GVAR(loadout_sam)] call _fnc_default];
...
_lines pushBack format ['#define SNIPER "%1"', [GVAR(loadout_sniper)] call _fnc_default];
_lines pushBack format ['#define SNIPER_MAG %1', [GVAR(loadout_sniper), GVAR(loadout_sniperMags), SNIPER_ROUNDS] call _fnc_getMags];
_lines pushBack format ['#define SNIPER_OPTIC %1', [[GVAR(loadout_sniperAttachments)] call _fnc_formatList] call _fnc_default];

_lines pushBack format ["// Spotter"];
_lines pushBack format ['#define SPOTTER "%1"', [GVAR(loadout_spotter)] call _fnc_default];
...
_lines pushBack format ['#define SMG "%1"', [GVAR(loadout_smg)] call _fnc_default];
...
_lines pushBack format ['#define PISTOL "%1"', [GVAR(loadout_pistol)] call _fnc_default];
