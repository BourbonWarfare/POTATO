...
class CfgPatches {
    class ADDON {
        ...
        requiredAddons[] = { "potato_core", "HAFM_Army_Units2", "HAFM_Air_Configs", "HAFM_ArmA2_Helis", "HAFM_Kiowa_Config", "HAFM_NH90_Config", "HAFM_ArmA2", "HAFM_Vehicles_Configs", "HAFM_Naval", "HAFM_NH90", "Kimi_UI" };
    ...
    class NH90: Helicopter_Base_H {
        ...
        class textureSources { // enables Virtual Garage skin functionality
            ...
            class FIN { // adds Finnish NH90 skin authored by troska and Centurion_101 via SFP: Finnish Forces Pack (https://steamcommunity.com/sharedfiles/filedetails/?id=917042703)
                ...
                textures[] = {"patch_HAFM\data\outerHaul_co.paa","patch_HAFM\data\upperTail_co.paa","patch_HAFM\data\misc_co.paa","patch_HAFM\data\doors_co.paa"};
            };
        };
        class MFD {
