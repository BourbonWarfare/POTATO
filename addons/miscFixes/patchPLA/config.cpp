            ...
            class MainTurret: MainTurret {
                class Turrets: Turrets {
                    class CommanderOptics: CommanderOptics {
                        class HitPoints {
                            class HitComTurret {
                                armor = -500; // formerly 0.3
                                minimalHit = 0.1; // formerly 0.03
                                explosionShielding = 1; // formerly 0.6
                            };
                            class HitComGun {
                                armor = -300; // formerly 0.3
                                minimalHit = 0.1; // formerly 0.03
                                explosionShielding = 1; // formerly 0.6
                            };
                        };
                ...
                class HitPoints {
                    class HitTurret {
                        armor = 0.30000001; // old value 1.2
                        passThrough = 0.25; // formerly 0
                        minimalHit = 0.05; // formerly 0.1
                        explosionShielding = 0.2; // old value 0.3
                    };
                    class HitGun {
                        armor = 0.60000002; // old value 0.8
                        passThrough = 0;
                        minimalHit = 0.1; // old value 0
                        explosionShielding = 0.40000001;
                    };
