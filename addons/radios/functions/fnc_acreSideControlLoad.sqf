...
(_ctrlGroup controlsGroupCtrl CFG_S_CHANNEL_IDC) ctrlAddEventHandler ["KeyUp", {call FUNC(acreSideControlChannelEditChange);}];
(_ctrlGroup controlsGroupCtrl CFG_S_SIDE_IDC) ctrlAddEventHandler ["ToolBoxSelChanged", {call FUNC(acreSideControlSideChange);}];
(_ctrlGroup controlsGroupCtrl RADIO_CHANNEL_IDC) ctrlAddEventHandler ["LBSelChanged", {call FUNC(acreSideControlChannelChange);}];
(_ctrlGroup controlsGroupCtrl RADIO_CHOOSE_IDC) ctrlAddEventHandler ["ToolBoxSelChanged", {call FUNC(acreSideControlRadioChange);}];
