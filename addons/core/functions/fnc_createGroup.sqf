 ...
 *
 * Examples:
 * [west, position player, ["SoldierWB"]] call potato_common_fnc_createGroup;
 * [east, [1,2,3], ["SoldierWB","SoldierWB"], "FORM", "_this setPos [4,5,6];"] call potato_common_fnc_createGroup;
 *
 * Public: Yes
 */
