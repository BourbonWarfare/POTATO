...
private _leftGroup = DISPLAY_BRIEF ctrlCreate [QUOTE(RscControlsGroup),BRIEFINGS_GROUP_L_IDC];
_leftGroup ctrlSetPosition [0,0.05,0.65,0.95];
_leftGroup ctrlCommit 0;
private _rightGroup = DISPLAY_BRIEF ctrlCreate [QUOTE(RscControlsGroup),BRIEFINGS_GROUP_R_IDC];
