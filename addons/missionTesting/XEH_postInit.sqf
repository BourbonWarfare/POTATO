...
GVAR(MissionTestingChecklistMaster) = [
    ["PRE-MISSION CHECKLIST",
        [
            ...
            ,["Ensure that if Safe Start ends automatically in Coop or uses a nonstandard length in a TvT (10 minutes is standard), it is clear from the slotting screen or a plan exists to inform leadership before mission start",D_CHECK,MISSION_TYPE_APPLIES_BOTH]
