...
PREP(openClientRespawn);
PREP(openRespawnEULA);
PREP(openRespawnMenuModule);
PREP(openRespawnMenuModuleClient);
...
PREP(ui_handleAgreeClick);
PREP(ui_handleCancelClick);
PREP(ui_handleChatClick);
PREP(ui_handleClientLoad);
PREP(ui_handleClientSlotClick);
PREP(ui_handleClientUnload);
PREP(ui_handleClientUnslotClick);
PREP(ui_handleCloseClick);
PREP(ui_handleDeleteClick);
PREP(ui_handleDeclineClick);
