...
class NotInBotChannel(commands.CheckFailure): pass
...
async def status(ctx):
    ...
    await ctx.send(steam_checkServer("Main", ("208.100.19.226", 2304)))
    await ctx.send(steam_checkServer("Alt",  ("208.100.19.226", 2370)))
